...
parser.add_argument('-b', '--base-url', dest='base_url', default='https://github.com/mixer/OBS-Studio-FTL')
parser.add_argument('-u', '--user', dest='user', default='mixer')
parser.add_argument('-c', '--channel', dest='channel', default='ftl')
